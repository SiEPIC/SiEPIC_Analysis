...
if __name__ == "__main__":
    ...
    root_path = r"D:\Documents\Uni\Year_4COOP\Docs\Analysis_Scripts\package\SampleData\data\1550_TE"
    analyzer_1 = Execute(root_path)
    results_df_1, report_path = analyzer_1.gen_analysis()
    print(results_df_1)
    all_reports.append(report_path)

    root_path = r"D:\Documents\Uni\Year_4COOP\Docs\Analysis_Scripts\package\SampleData\data\1550_TM"
    ...
    combined_pdf_path = os.path.join(os.path.dirname(root_path), "analysis_results", "combined.pdf")
